...
# `plastier/plastier`: Contributing guidelines

Hi there!
Thanks for taking an interest in improving plastier/plastier.

This page describes the recommended nf-core way to contribute to both plastier/plastier and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of plastier/plastier.
...
- [ ] Check whether a GitHub [issue](https://github.com/plastier/plastier/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [plastier/plastier repository](https://github.com/plastier/plastier) to your GitHub account.
...
nf-core semi-standardises how you write code and other contributions to make the plastier/plastier code and processing logic more understandable for new contributors and to ensure quality.
